var renderData  = {
    ...
    "formItem":[ // formItme 集合
        {
            fieldCode:"aaaa2",  //数据库字段名
            fieldType:"string", //数据库字段类型。
            ele: 'select',      //渲染方式。
            conf:{
              configIcon:true,  //是否开启自定义图标。
              icons:["setting"],// 图标名称。iview图标。
              label:"字段2",    //字段中文名 label
              value:'',         //默认值     可拓展
              options:[{name:'选项一',value:'1'},{name:'选项二',value:'2'},{name:'选项三',value:'3'},{name:'选项四',value:'4'}]
            }
        },
    ]
}
